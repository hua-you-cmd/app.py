...
import { copyAllCodeToClipboard, copyStreamlitAppToClipboard } from './utils/codeCollector';
...
export default function App() {
 ...
 const [isAIConsultOpen, setIsAIConsultOpen] = useState(false);
  ...
  const handleDirectCopyStreamlit = async () => {
    playClickSound();
    const success = await copyStreamlitAppToClipboard();
    if (success) {
      setToastMessage("🐍 Python (Streamlit) 用 app.py コードを直接コピーしました！");
      setTimeout(() => setToastMessage(null), 3500);
    }
  };

  const handleDirectCopyReact = async () => {
    playClickSound();
    const success = await copyAllCodeToClipboard();
    if (success) {
      setToastMessage("✅ 全TypeScript/Reactソースコードをコピーしました！");
      setTimeout(() => setToastMessage(null), 3500);
    }
  };
          ...
          <div className="flex items-center gap-3 text-center md:text-left">
            ...
            <div>
              <div className="flex items-center justify-center md:justify-start gap-2 flex-wrap">
                <span className="text-[11px] font-black bg-amber-400 text-stone-950 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                  Python (Streamlit) & React 出力対応
                </span>
                <span className="text-xs text-amber-300/90 font-mono">
                  Streamlit用 app.py / 全ファイル一括コピー
                </span>
              </div>
              <h3 className="text-base sm:text-lg font-extrabold text-stone-100 pt-0.5">
                ソースコード取得・ワンクリック一括コピー
              </h3>
            </div>
          </div>

          <div className="flex items-center gap-2 sm:gap-2.5 w-full md:w-auto shrink-0 flex-wrap justify-center">
            <button
              onClick={handleDirectCopyStreamlit}
              className="flex-1 md:flex-none px-4 py-2.5 rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-400 to-emerald-500 hover:brightness-110 text-stone-950 font-black text-xs sm:text-sm flex items-center justify-center gap-1.5 shadow-xl shadow-emerald-950/40 transition active:scale-95 border border-emerald-200 cursor-pointer"
              title="Python (Streamlit) の app.py コードを直接コピー"
            >
              <Copy className="w-4 h-4 text-stone-950" />
              <span>🐍 Python (app.py) コピー</span>
            </button>

            <button
              onClick={handleDirectCopyReact}
              className="flex-1 md:flex-none px-4 py-2.5 rounded-2xl bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 hover:brightness-110 text-stone-950 font-black text-xs sm:text-sm flex items-center justify-center gap-1.5 shadow-xl shadow-amber-500/25 transition active:scale-95 border border-amber-200 cursor-pointer"
              title="React (TypeScript) の全ソースコードを結合してコピー"
            >
              <Copy className="w-4 h-4 text-stone-950" />
              <span>全Reactコードコピー</span>
            </button>
            ...
            <button
              ...
              className="px-3.5 py-2.5 rounded-2xl bg-stone-850 hover:bg-stone-800 border border-stone-700 text-amber-300 font-bold text-xs sm:text-sm flex items-center justify-center gap-1.5 transition active:scale-95 cursor-pointer"
            >
...
// ==========================================
// File: components/AcupointDiagramModal.tsx
// ==========================================
...
// ==========================================
// File: components/AIConsultantModal.tsx
// ==========================================
import React, { useState } from 'react';
...
// ==========================================
// File: components/BirthdateFiveElementsCard.tsx
// ==========================================
import React, { useState, useEffect } from 'react';
...
// ==========================================
// File: components/CodeCopyModal.tsx
// ==========================================
...
// ==========================================
// File: components/DailyQuestsAndFortune.tsx
// ==========================================
import React, { useState } from 'react';
...
// ==========================================
// File: components/FiveElementsChart.tsx
// ==========================================
import React, { useState } from 'react';
...
// ==========================================
// File: components/OrganClock.tsx
// ==========================================
import React, { useState, useEffect } from 'react';
...
// ==========================================
// File: components/QuestionnaireModal.tsx
// ==========================================
...
// ==========================================
// File: components/RelaxBGMPlayer.tsx
// ==========================================
import React, { useState, useEffect, useRef } from 'react';
...
// ==========================================
// File: components/ShanghanProfile.tsx
// ==========================================
import React, { useState, useEffect } from 'react';
...
// ==========================================
// File: components/TcmGlossaryModal.tsx
// ==========================================
import React from 'react';
...
// ==========================================
// File: components/YouTubeVideoSection.tsx
// ==========================================
import React, { useState } from 'react';
